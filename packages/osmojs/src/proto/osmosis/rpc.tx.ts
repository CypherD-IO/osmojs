...
export const createRPCMsgClient = async ({ rpc }: { rpc: Rpc }) => ({
  cosmos: {
    ...
    crisis: {
      v1beta1: new (
        await import("../cosmos/crisis/v1beta1/tx.rpc.msg")
      ).MsgClientImpl(rpc),
    },
    distribution: {
      v1beta1: new (
    ...
    evidence: {
      v1beta1: new (
        await import("../cosmos/evidence/v1beta1/tx.rpc.msg")
      ).MsgClientImpl(rpc),
    },
    feegrant: {
      v1beta1: new (
    ...
    nft: {
      v1beta1: new (
        await import("../cosmos/nft/v1beta1/tx.rpc.msg")
      ).MsgClientImpl(rpc),
    },
    slashing: {
      v1beta1: new (
        await import("../cosmos/slashing/v1beta1/tx.rpc.msg")
      ).MsgClientImpl(rpc),
    },
    staking: {
      v1beta1: new (
  ...
  osmosis: {
    gamm: {
      poolmodels: {
        balancer: {
          v1beta1: new (
            await import("./gamm/pool-models/balancer/tx.rpc.msg")
          ).MsgClientImpl(rpc),
        },
        stableswap: {
          v1beta1: new (
            await import("./gamm/pool-models/stableswap/tx.rpc.msg")
          ).MsgClientImpl(rpc),
        },
      },
